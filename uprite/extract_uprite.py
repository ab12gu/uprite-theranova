...
def extract(directory):
    ...
    for k, p in enumerate(pace):
        ...
        plt.plot([gyro['sec'][x] for x in gyro_troughs],
                 [ang_pos[x] for x in gyro_troughs], 'c^')
        plt.plot([gyro['sec'][x] for x in gyro_peaks],
                 [ang_pos[x] for x in gyro_peaks], 'co')
        ...
        plt.plot([accel['sec'][x] for x in to_locations],
                 [accel_lp[x] for x in to_locations], 'k^')
        ...
        plt.figure()
        plt.plot(accel['sec'], accel_lp)
        plt.plot([accel['sec'][x] for x in accel_peaks],
                 [accel_lp[x] for x in accel_peaks], 'co')
        ...
        HS, TO = right_left(accel_peaks, all_gyro_spikes, gyro_troughs,
                            to_locations)
