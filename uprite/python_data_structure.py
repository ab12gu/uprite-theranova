...
from utils.visualize_structure import \
    visualize_structure as visual  # see dict structure
from utils.filetype_conversion.zeno_to_dict import \
    convert as zeno_to_dict  # parses reference system data
from utils.filetype_conversion.mat_to_dict import \
    convert as mat_to_dict  # .mat filetype conversion
from utils.filetype_conversion.zeno_to_dict import \
    offset as first_step  # export first footstep
...
def extract(input_directory, output_directory, filename):
    ...
    mat_file = os.path.join(uprite_data_directory,
                            "imuData.mat")  # put into external file...
