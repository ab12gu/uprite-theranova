...
if __name__ == "__main__":
    ...
    folder_type = input(
        "Does the directory contain multiple patient's data? (y or n): ")
    ...
    output_type = input(
        "Will the directory store multiple patient's data? (y or n): ")

    assert output_type == 'y', "The output needs to parent folder containing all patient's data"

    create_structure(input_directory, output_directory,
                     folder_type)  # create python structure
    check_uprite_data(output_directory,
                      folder_type)  # check how much data was recorded
    ...
    zeno_gait(output_directory,
              folder_type)  # calculates physical gait characteristics from TO/HS
    uprite_gait(output_directory,
                folder_type)  # calculates physical gait characteristics from TO/HS
