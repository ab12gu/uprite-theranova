...
def convert(RS_file, offset):
    ...
    # Data File
    header_size = 10
    a = np.genfromtxt(RS_file[0], delimiter=';', skip_header=header_size,
                      usecols=np.arange(0, 49),
                      usemask=False, dtype=None, comments=None, encoding=None,
                      missing_values='1')
    ...
    b = np.genfromtxt(RS_file[0], delimiter=';', skip_footer=a_size,
