...
with open('TO_HS.csv', 'w') as csvfile:
...
# iterate through each patient file
	for c, filename in enumerate(os.listdir(UR_input_dir)):
		...
		for p in pace:
			output.writerow([patient_number, p, 'RS'] + RS[p]['HS']['r'])
			output.writerow([patient_number, p, 'RS'] + RS[p]['HS']['l'])
			output.writerow([patient_number, p, 'RS'] + RS[p]['TO']['r'])
			output.writerow([patient_number, p, 'RS'] + RS[p]['TO']['l'])
			output.writerow([patient_number, p, 'UR'] + UR[p]['HS']['r'])
			output.writerow([patient_number, p, 'UR'] + UR[p]['HS']['l'])
			output.writerow([patient_number, p, 'UR'] + UR[p]['TO']['r'])
			output.writerow([patient_number, p, 'UR'] + UR[p]['TO']['l'])	
			output.writerow([])
