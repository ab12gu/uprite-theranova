...
load('../organized_init_tailb/Hamel Data  11292016/Test 7/Tailbone/imuData.mat')
%load imuData.mat
close all
...
gravityAccelX = lowPassfilter(usedAccelData.x, [0.1 0.7], 100);
...
gravityAccelY = lowPassfilter(usedAccelData.y, [0.1 0.7], 100);
...
gravityAccelZ = lowPassfilter(usedAccelData.z, [0.1 0.7], 100);
...
earthXFilt = lowPassfilter(earthAccelDeltaVectorHolder(1,:), [10 11], 100);
